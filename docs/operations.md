...
`delta-tool-index-stack` is centered on cli tools work in Python. The technical target is: Package a Python local lab for index analysis with capacity fixtures, allocation and spill reports, and documented operating limits.
...
The score is deterministic. The current threshold is 173. Risk has a penalty of 7, latency has a penalty of 2, and weight contributes a bonus of 4.
