"""Regression checks for the delta-tool-index-stack casebook."""
...
from casebook.harness import assert_expected, delta_tool_index_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(delta_tool_index_stack_summary(), assert_expected())
